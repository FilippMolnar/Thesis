...
Once training is completed the separate evaluation dataset of 12 different conditios of 40 images
 is used to the test set is evaluate the performance of models.
