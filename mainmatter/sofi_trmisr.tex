...
We reduced the channel width from 64 to 24 to lower latency and to match the
  RESURF
  configuration~\cite{resurf2024}, which enables a fair comparison of fusion mechanism.
  \todo{cut down from 64 to 24 to match RESURF. 
I understand the motivation, but later in your conclusions, 
you that the encoder/decoder is the bottleneck, 
so does it still justify cutting from 64 to 24?}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth]{figures/motion_shit.png}
