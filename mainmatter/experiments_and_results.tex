...
only TR-MISR variant that remains feasible. 
...
batch MISRGRU baseline on every condition (FH/FL/SH/SL: $0.913/0.913/0.884/0.878$
vs.\ $0.911/0.901/0.875/0.858$).
The benefit of TBPTT training becomes clear once more frames are accumulated: at 100 frames
RSP rises to $0.929/0.927/0.916/0.888$, a consistent gain over the 20-frame batch model
that is most pronounced in the harder slow and low-SNR conditions
(Figure~\ref{fig:lln35_vs_foundational_misrgru}).
The batch MISRGRU cannot benefit in this way, as its fixed 20-frame input window prevents
it from integrating additional context and TRMISR is limited by its compute and memory. 
...
Decorrelation analysis estimates the ground-truth images themselves at approximately
...
Across all conditions, RSP rises steeply over the first $\sim$50 frames and then plateaus.
The fast conditions (FH, FL) reach their plateau earliest, exceeding $0.92$ by 50 frames,
whereas the slow conditions improve more gradually: the slow/low-SNR case (SL) climbs from
$\sim$0.65 at 8 frames to its peak near $0.90$ only around 75 frames, since each emitter's
on/off cycle is long relative to the frame rate and more frames are needed before the window
samples enough independent blink events.

Beyond this peak, quality no longer improves and the slow conditions even decline slightly:
SL falls from $\sim$0.90 at 75 frames to $\sim$0.85 by 200 frames and stays there, while SH
settles just below its peak. The fast conditions hold their plateau out to 500 frames. This
decline in the high-frame regime should be read with caution, since past 100 frames the
looped sequence re-presents already-seen frames rather than new fluctuation statistics. Taken
together, accumulating roughly 50--75 frames captures essentially all of the attainable
...
\begin{table}[h]
  \centering
  \caption{RSP\,$\times 100$ at 20 accumulated frames across three motion conditions.
  FH\,=\,fast/high-SNR, FL\,=\,fast/low-SNR, SH\,=\,slow/high-SNR, SL\,=\,slow/low-SNR. Best value per
  condition in bold.}
  ...
  DPA-DeformConv    & $87.2 \pm 3.6$ & $83.0 \pm 4.5$ & $79.9 \pm 2.6$ & $60.7 \pm 8.7$ \\
  Finetune-motion   & $88.9 \pm 1.0$ & $88.4 \pm 1.1$ & $84.3 \pm 1.5$ & $76.9 \pm 1.6$ \\
  LLN35-larger-GRU  & $\mathbf{91.5} \pm 0.6$ & $\mathbf{91.1} \pm 0.7$ & $88.4 \pm 1.0$ & $87.7 \pm
  1.1$ \\
  MISR-GRU          & $91.2 \pm 0.5$ & $90.0 \pm 0.6$ & $87.6 \pm 0.9$ & $85.8 \pm 1.0$ \\
  TR-MISR           & $90.7 \pm 0.8$ & $90.5 \pm 0.9$ & $\mathbf{89.6} \pm 1.2$ & $\mathbf{88.5} \pm
  1.2$ \\
  \midrule
  \multicolumn{5}{l}{\textit{Moving (0.2\,px/frame\,$\approx 2.0\,\mu$m/s)}} \\
  DPA-DeformConv    & $\mathbf{88.9} \pm 1.9$ & $\mathbf{87.3} \pm 2.0$ & $\mathbf{82.9} \pm 2.3$ &
  $\mathbf{74.8} \pm 2.9$ \\
  ...
  DPA-DeformConv    & $\mathbf{88.0} \pm 2.0$ & $\mathbf{85.8} \pm 2.1$ & $\mathbf{80.0} \pm 2.6$ &
  $\mathbf{70.3} \pm 4.3$ \\
