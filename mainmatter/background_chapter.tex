...
entirely from the blinking terms $s_k(t)$ — a fact that both SOFI and the deep-learning models in
this thesis exploit.
...
so the naive inverse $\hat{X} = \hat{Y}/\hat{H}$ amplifies noise catastrophically at 
...
Lucy-Richardson deconvolution stabilise the inversion but require accurate 
