...
principles. 
Structured Illumination Microscopy (SIM) illuminates
...
In contrast to SIM, Stimulated Emission Depletion (STED) microscopy
...
Single-Molecule Localization Microscopy (SMLM) techniques such as 
...
Super-resolution Optical Fluctuation Imaging (SOFI) uses the temporal and spatial correlations
