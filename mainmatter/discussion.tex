...
or inference speed:
In aggregate resolution scaled pearson correlation, TRMISR with a shallow transofmer (1h1d) is competitive with
...
Importantly, the motion-finetuned DPA model outperforms staticaly trained Streaming MISRGRU
