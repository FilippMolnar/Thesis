...
\todo{output degradation in streaming models, not exactly present}
\todo{difficulty training streaming dpa on live cell where GT data is not available}
\todo{temporal resolution of streaming models based on number of frames that are used}
