...
Importantly, the motion-finetuned DPA model outperforms staticaly trained Streaming MISRGRU
 on both static and moving evaluation dataset. TRMISR still achieves higher reconstruction accuracy
 on slow blinking and low signal-to-noise ratio images (Figure~\ref{fig:motion_snr_static}).
